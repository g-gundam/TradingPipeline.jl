...
# ╔═╡ c9ec0a5a-4cc6-428a-8b06-277dad3b3257
md"""
### Results
"""
...
# ╔═╡ c2c8a989-ffd1-445e-a41e-80db397ed723
md"""
### Results
"""
...
# ╔═╡ 74434726-8430-4a98-9657-ee95f7250ac4
md"""
### Results
"""
...
md"""
### Trade 8: What if we went long?
- These would have been decent long entries.
- They're better long entries than the ones generated by the long-only strategies at these particular points in the market structure.
  + Trades 6 & 8 here correspond to the late entry trades 4 & 5 from the previous simulator runs.
  + With these entries, they'd no longer be late.
"""
